...
const SingleItemEverything = () => {

    const { everythingArticle, setSingleItem } = useContext(EverythingArticlesContext);
    const { articleId } = useParams();

    useEffect(() => {
        const fetchItem = async () => {
          try {
            const response = await fetch(`https://newsapi.org/v2/everything?q=${articleId}&apiKey=47bbec3a79074aab9cd91542f4ccce46`);
      ...
      const date = new Date(everythingArticle.publishedAt);
...
export default SingleItemEverything;